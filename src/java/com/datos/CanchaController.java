...
public class CanchaController implements Serializable {
    ...
    @EJB
    private com.bean.CanchaFacade ejbFacade;
    ...
    private CanchaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("CanchaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("CanchaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("CanchaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
